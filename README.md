...
Готовый **.dmg** для установки на Mac можно взять в [**Releases**](https://github.com/BrezhnevEugen/WorkMonitor/releases) (удобнее всего [последняя версия](https://github.com/BrezhnevEugen/WorkMonitor/releases/latest)): в блоке **Assets** скачайте файл `WorkMonitor-1.0.0.dmg`, откройте его и перетащите **Work Monitor** в папку «Программы».
